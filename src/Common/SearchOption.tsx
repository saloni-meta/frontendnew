                ...
                <div className="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                    <SimpleBar style={{ height: "320px" }}>
                        ...
                        <div className="dropdown-item bg-transparent text-wrap">
                            <Link to={process.env.PUBLIC_URL + "/"} className="btn btn-soft-secondary btn-sm btn-rounded">how to setup <i
                                className="mdi mdi-magnify ms-1"></i></Link>
                            <Link to={process.env.PUBLIC_URL + "/"} className="btn btn-soft-secondary btn-sm btn-rounded">buttons <i
                                className="mdi mdi-magnify ms-1"></i></Link>
                        </div>
                    ...
                    <div className="text-center pt-3 pb-1">
                        <Link to={process.env.PUBLIC_URL + "/pages-search-results"} className="btn btn-primary btn-sm">View All Results
