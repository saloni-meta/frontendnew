    ...
    <div className="dropdown-head bg-primary bg-pattern rounded-top">
        <div className="p-3">
            <Row className="align-items-center">
                <Col>
                    <h6 className="m-0 fs-lg fw-semibold text-white"> Notifications </h6>
                </Col>
                <div className="col-auto dropdown-tabs">
                    <span className="badge badge-soft-light fs-sm"> 4 New</span>
                </div>
            </Row>
        </div>
    ...
    <TabContent activeTab={activeTab} id="notificationItemsTabContent4">
            ...
            <SimpleBar style={{ maxHeight: "300px" }} className="pe-2">
                <div className="text-reset notification-item d-block dropdown-item">
                    <div className="d-flex">
                        <div className="flex-shrink-0 avatar-xs me-3">
                            <span className="avatar-title bg-soft-info text-info rounded-circle fs-lg">
                ...
                <div className="text-reset notification-item d-block dropdown-item">
                    <div className="d-flex">
                        ...
                        <div className="flex-1">
                            <Link to="#"><h6 className="mt-0 mb-1 fs-sm fw-semibold">Angela Bernier</h6></Link>
                ...
                <div className="text-reset notification-item d-block dropdown-item">
                    <div className="d-flex">
                        <div className="flex-shrink-0 avatar-xs me-3">
                            <span className="avatar-title bg-soft-danger text-danger rounded-circle fs-lg">
                                <i className='bx bx-message-square-dots' ></i>
                            </span>
                        </div>
                        <div className="flex-1">
                            <h6 className="mt-0 mb-2 fs-sm lh-base">You have received <b className="text-success">20</b> new messages in the conversation</h6>
                            <p className="mb-0 fs-2xs fw-medium text-uppercase text-muted">
                ...
                <div className="text-reset notification-item d-block dropdown-item">
                    <div className="d-flex">
                        <img src={avatar8}
                            className="me-3 rounded-circle avatar-xs" alt="user-pic" />
                        <div className="flex-1">
                            <Link to="#"><h6 className="mt-0 mb-1 fs-sm fw-semibold">Maureen Gibson</h6></Link>
                            <div className="fs-sm text-muted">
                ...
                <div className="text-reset notification-item d-block dropdown-item">
                    <div className="d-flex">
                        <img src={avatar3}
                            className="me-3 rounded-circle avatar-xs" alt="user-pic" />
                        <div className="flex-1">
                            <Link to="#"><h6 className="mt-0 mb-1 fs-sm fw-semibold">James Lemire</h6></Link>
                            <div className="fs-sm text-muted">
                                <p className="mb-1">We talked about a project on linkedin.</p>
                            </div>
                            <p className="mb-0 fs-2xs fw-medium text-uppercase text-muted">
                ...
                <div className="text-reset notification-item d-block dropdown-item">
                    <div className="d-flex">
                        <img src={avatar6}
                            className="me-3 rounded-circle avatar-xs" alt="user-pic" />
                        <div className="flex-1">
                            <Link to="#"><h6 className="mt-0 mb-1 fs-sm fw-semibold">Kenneth Brown</h6></Link>
                            <div className="fs-sm text-muted">
        ...
        <TabPane tabId="3" id="alerts-tab1" className="p-4">
            ...
            <div className="text-center pb-5 mt-2">
                <h6 className="fs-xl fw-semibold lh-base">Hey! You have no any notifications </h6>
            </div>
        </TabPane>
    </TabContent>
</div>
