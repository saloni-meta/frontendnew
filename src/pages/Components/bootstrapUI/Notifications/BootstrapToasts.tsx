...
const BootstrapToasts = () => {
    document.title=" Notifications | Steex Admin & Dashboard Template";
    ...
    return (
        <React.Fragment>
            <div className="page">
                <Breadcrumb pageTitle="Base Ui" title="Notifications" />
                <Row>
                    <Col lg={12}>
                        <Card>
                            <Card.Header>
                                        ...
                                        <Col xxl={6}>
                                            ...
                                            <Toast className="fade" show={toast1} onClose={togglesetToast1}>
                                                <Toast.Header>
                                                    ...
                                                    <span className="fw-semibold me-auto">Steex</span>
