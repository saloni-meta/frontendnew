...
<!-- Avatar With Content -->
    <div className="avatar-xxs mt-3">
        <div className="avatar-title rounded bg-soft-primary text-primary fs-3xs">
            XXS
        </div>
    </div>
    ...
    <div className="avatar-sm mt-3">
        <div className="avatar-title rounded bg-soft-success text-success fs-md">
            SM
        </div>
    </div>
    
    <div className="avatar-md mt-3">
        <div className="avatar-title rounded bg-soft-info text-info fs-lg">
            MD
        </div>
    </div>
    
    <div className="avatar-lg mt-3">
        <div className="avatar-title rounded bg-soft-warning text-warning fs-2xl">
            LG
        </div>
    </div>
    
    <div className="avatar-xl mt-3">
        <div className="avatar-title rounded bg-soft-danger text-danger fs-4xl">
            XL
        </div>
    </div>
`;
