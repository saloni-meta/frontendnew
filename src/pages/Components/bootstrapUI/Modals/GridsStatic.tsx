                    ...
                    <form action="#">
                        <div className="row g-3">
                            ...
                            <Col lg={12}>
                                ...
                                <div>
                                    <div className="form-check form-check-inline">
                                        <Form.Check type="radio" name="inlineRadioOptions" id="inlineRadio1" defaultValue="option1" />
                                        <Form.Label className="form-check-label" htmlFor="inlineRadio1">Male</Form.Label>
                                    </div>
                                    <div className="form-check form-check-inline">
                                        <Form.Check type="radio" name="inlineRadioOptions" id="inlineRadio2" defaultValue="option2" />
                                        <Form.Label className="form-check-label" htmlFor="inlineRadio2">Female</Form.Label>
                                    </div>
                                    <div className="form-check form-check-inline">
                                        <Form.Check type="radio" name="inlineRadioOptions" id="inlineRadio3" defaultValue="option3" />
                            ...
                            <Col xxl={6}>
                                ...
                                <Form.Control type="password" className="form-control" id="passwordInput" defaultValue="451326546" placeholder="Enter password" />
                            </Col>
                            <Col lg={12}>
