...
<Button variant='success' className="btn-label"><i className="ri-check-double-line label-icon align-middle fs-lg me-2"></i> Success</Button>

<Button variant='warning' className="btn-label"><i className="ri-error-warning-line label-icon align-middle fs-lg me-2 "></i> Warning</Button>

<!-- Rounded with Label -->
<Button variant='primary' className="btn-label rounded-pill"><i className="ri-user-smile-line label-icon align-middle rounded-pill fs-lg me-2"></i> Primary</Button>

<Button variant='success' className="btn-label rounded-pill"><i className="ri-check-double-line label-icon align-middle rounded-pill fs-lg me-2"></i> Success</Button>

<Button variant='warning' className="btn-label rounded-pill"><i className="ri-error-warning-line label-icon align-middle rounded-pill fs-lg me-2 "></i> Warning</Button>
...
const CustomSizingButtonsExample = () => (
    <PrismCode
        code={customSizing}
        language={("js")}
        plugins={["line-numbers"]}
...
`
<!-- Focus Ring Utilities Buttons -->

<p><Link to="#" class="d-inline-flex focus-ring focus-ring-primary py-1 px-2 text-decoration-none border rounded-2">Primary focus</Link></p>

<p><Link to="#" class="d-inline-flex focus-ring focus-ring-secondary py-1 px-2 text-decoration-none border rounded-2">Secondary focus</Link></p>

<p><Link to="#" class="d-inline-flex focus-ring focus-ring-success py-1 px-2 text-decoration-none border rounded-2">Success focus</Link></p>

<p><Link to="#" class="d-inline-flex focus-ring focus-ring-danger py-1 px-2 text-decoration-none border rounded-2">Danger focus</Link></p>

<p><Link to="#" class="d-inline-flex focus-ring focus-ring-warning py-1 px-2 text-decoration-none border rounded-2">Warning focus</Link></p>

<p><Link to="#" class="d-inline-flex focus-ring focus-ring-info py-1 px-2 text-decoration-none border rounded-2">Info focus</Link></p>

<p><Link to="#" class="d-inline-flex focus-ring focus-ring-light py-1 px-2 text-decoration-none border rounded-2">Light focus</Link></p>

<p><Link to="#" class="d-inline-flex focus-ring focus-ring-dark py-1 px-2 text-decoration-none border rounded-2">Dark focus</Link></p>
`;

const FocusRingUitilitiesExample = () => (
    <PrismCode
