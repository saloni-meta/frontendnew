...
const Default = () => {
    document.title = " Offcanvas | Steex Admin & Dashboard Template";
    ...
    return (
        <React.Fragment>
            <div className="page">
                <Breadcrumb pageTitle="Base Ui" title="Offcanvas" />
                <Row>
                    <Col lg={12}>
                        <Card>
                            <Card.Header>
                                            ...
                                            <div className="acitivity-timeline p-4">
                                                ...
                                                <div className="acitivity-item py-3 d-flex">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        ...
                                                        <p className="text-muted mb-2">added a new member to Steex dashboard</p>
