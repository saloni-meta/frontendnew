...
const HtmlCssJs = () => {
    document.title=" Highlight | Steex Admin & Dashboard Template";
                    ...
                    <Col lg={12}>
                        <Card>
                            ...
                            <Card.Body className="bg-light border-bottom border-top bg-opacity-25">
                                <h5 className="fs-xs text-muted mb-0"> HTML Preview</h5>
                            </Card.Body>
                            <Card.Body>
                                <pre>
                    ...
                    <Col lg={12}>
                        <Card>
                            ...
                            <Card.Body className="bg-light border-bottom border-top bg-opacity-25 d-flex align-items-center">
                                <h5 className="flex-grow-1 fs-xs text-muted mb-0">CSS Preview</h5>
                ...
                <Row>
                    <Col lg={12}>
                        <Card>
                            ...
                            <Card.Body className="bg-light border-bottom border-top bg-opacity-25 d-flex align-items-center">
                                <h5 className="flex-grow-1 fs-xs text-muted mb-0">Javascript Preview</h5>
                                <div className="flex-shrink-0">
                                    <Link to="#!"><i className="bi bi-clipboard"></i></Link>
                                </div>
                            </Card.Body>
