...
const GroupedStackedCharts = ({ dataColors }: any) => {
    var columnGroupedStackedColors = getChartColorsArray(dataColors);
    // dayjs.extend(window.dayjs_plugin_quarterOfYear)
...
const DumbbellChart = ({ dataColors }: any) => {
    var columnDumbbellColors = getChartColorsArray(dataColors);
    // dayjs.extend(window.dayjs_plugin_quarterOfYear)
    ...
    return <Chart dir="ltr" className="apex-charts" series={series} options={options} type="rangeBar" height={350} />;
};
