...
const ColumnChart = () => {
    document.title=" Apex Column Charts | Steex Admin & Dashboard Template";
                ...
                <Row>
                    <Col lg={6}>
                        <Card>
                            ...
                            <Card.Body>
                                <GroupedStackedCharts dataColors='["--tb-primary", "--tb-success","--tb-secondary", "--tb-warning"]' />
                            </Card.Body>
                        </Card>
                    </Col>
                    ...
                    <Col lg={6}>
                        <Card>
                            ...
                            <Card.Body>
                                <DumbbellChart dataColors='["--tb-primary", "--tb-success"]' />
                            </Card.Body>
                        </Card>
                    </Col>
                </Row>
