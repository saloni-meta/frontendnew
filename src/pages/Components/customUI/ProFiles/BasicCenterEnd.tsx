...
const BasicCenterEnd = () => {
    ...
    return (
        <React.Fragment>
            <div className="page">
                <Breadcrumb pageTitle="Custom UI" title="Profile" />
                <Row>
                    <Col lg={12}>
                        <Card>
                            <Card.Header>
                                ...
                                <Card.Body className="rounded profile-basic" style={{backgroundImage: `url(${img4})`, backgroundSize: "cover"}}></Card.Body>
                                    ...
                                    <Card.Body className="pt-0">
                                        <Row className="justify-content-between gy-4">
                                            <Col xl={5} md={7}>
                                                <h5 className="fs-xl">Edward Diana</h5>
                                                ...
                                                <div className="hstack gap-2">
                                                    ...
                                                    <Button variant='soft-info' className="btn-icon bg-info-subtle text-info"><i className="bi bi-chat-left-text"></i></Button>

                                                    <Dropdown role="button">
                                                        <Dropdown.Toggle as="a" className="btn bg-danger-subtle text-danger btn-icon arrow-none">
                                            ...
                                            <Col xl={3} md={5}>
                                                ...
                                                <div>
                                                    ...
                                                    <ul className="d-flex gap-2 flex-wrap list-unstyled mb-0">
                                                        <li>
                                                            <span className="badge bg-secondary-subtle text-dark">Business Marketing</span>
                                                        </li>
                                                        <li>
                                                            <span className="badge bg-secondary-subtle text-dark">Google Ads Management</span>
                                                        </li>
                                                        <li>
                                                            <span className="badge bg-secondary-subtle text-dark">Social Ads Management</span>
                                                        </li>
                                                        <li>
                                                            <span className="badge bg-secondary-subtle text-dark">Content SEO</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </Col>
                                        ...
                                        <Row className="justify-content-center gy-4">
                                            <Col lg={5} className="text-center">
                                                ...
                                                <div className="hstack gap-2 justify-content-center">
                                                    <Button variant="primary">Invite to Project</Button>
                                                    <Button variant='info-subtle' className="btn-icon bg-info-subtle text-info"><i className="bi bi-chat-left-text"></i></Button>
